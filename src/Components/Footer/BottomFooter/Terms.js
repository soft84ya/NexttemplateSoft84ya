...
const CompanyDetails = ({ handleClose }) => {
    return (
        <>
            <DialogTitle id="company-details-title">Company Information</DialogTitle>
            <DialogContent dividers={true}>
                ...
                >
                    <div className="company-details-container">
                        <h1>Soft84ya</h1>
                        <p><strong>Subsidiary of:</strong> Dollor Infotech Pvt. Ltd.</p>
                        <p><strong>Owner:</strong> Abhishek Chaurasia</p>

                        <h2>Taglines</h2>
                        <ul>
                            <li>Soft84ya - <em>"Think differ."</em></li>
                        </ul>
